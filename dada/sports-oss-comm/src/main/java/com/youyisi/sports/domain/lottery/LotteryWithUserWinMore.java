...
public class LotteryWithUserWinMore extends BaseEntity{
	/**
	 * 
	 */
	...
	private Integer win; //中奖情况 -1未中奖，1-5等奖
	private Integer userLottery; //购买量情况
	
	private List<LotteryWinMore> lotteryWinMore;//中奖统计数据
	...
	public Integer getUserLottery() {
		return userLottery;
	}
	public void setUserLottery(Integer userLottery) {
		this.userLottery = userLottery;
	}
	public List<LotteryWinMore> getLotteryWinMore() {
		return lotteryWinMore;
	}
	public void setLotteryWinMore(List<LotteryWinMore> lotteryWinMore) {
		this.lotteryWinMore = lotteryWinMore;
	}
}
