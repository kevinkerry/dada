...
<head>
    ...
    <style>
        ...
        .title .title-line {
            border-bottom: 0.05rem dashed #3B3A3A;
        }
        .title .title-name {
            position: absolute;
            left: 50%;
...
<div class="title">
    ...
    <div class="title-name">最<span>“美腻”</span>奖</div>
</div>
<ul class="item-list">
    <c:forEach var="luck" items="${luckUsers1}">
        <li>
...
<div class="title">
    <div class="title-line"></div>
    <div class="title-name">最<span>“活力”</span>奖</div>
</div>
<ul class="item-list">
    <c:forEach var="luck" items="${luckUsers2}">
        <li>
            <img class="user-icon" src="${luck.userInfo.headimgurl}">
                ${luck.userInfo.nickname}
            <div class="user-prize">抽到<span>${luck.luck.name}</span></div>
...
<div class="title">
    <div class="title-line"></div>
    <div class="title-name">最<span>“健康”</span>奖</div>
</div>
<ul class="item-list">
    <c:forEach var="luck" items="${luckUsers3}">
        <li>
            <img class="user-icon" src="${luck.userInfo.headimgurl}">
                ${luck.userInfo.nickname}
            <div class="user-prize">抽到<span>${luck.luck.name}</span></div>
...
<div class="title">
    <div class="title-line"></div>
    <div class="title-name">最<span>“啊哦”</span>奖</div>
</div>
<ul class="item-list">
    <c:forEach var="luck" items="${luckUsers4}">
        <li>
            <img class="user-icon" src="${luck.userInfo.headimgurl}">
                ${luck.userInfo.nickname}
            <div class="user-prize">抽到<span>${luck.luck.name}</span></div>
