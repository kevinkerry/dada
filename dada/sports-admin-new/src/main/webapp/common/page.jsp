<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
  <nav style="float:left;">
  	...
  	<ul class="pager" style="margin-top: 0px;">
		<li >
		第&nbsp;<input type="text"  onchange="javascript:goPage2(this.value);" value="${page.currentPage}" style="width: 20px;text-align: center;"/>&nbsp;/&nbsp;${page.totalPages}&nbsp;页
		&nbsp;每页&nbsp;
		<select id="page_size" onchange="javascript:goPage(1, this.value);" style="cursor: pointer;">
			<c:choose>
