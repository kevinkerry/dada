$(function(){
	...
	$('#fileupload').fileupload({
		...
		previewCrop : true
      		...
      		var html='<div class="imgbox" data-src="'+result.results.path[0]+'" style="z-index:1;background-image: url('+img+');" draggable="true" ondragstart="drag(event);"><img src="http://admin.dadasports.cn/resources/images/del.png" width="20px" height="20px;" /></div>';
      		$("#imglist").append(html);
        });
