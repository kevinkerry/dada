...
function PCAS() {
	this.SelP = arguments[0];
	this.SelC = arguments[1];
	this.SelA = arguments[2];
	this.DefP = arguments.length == 6 ? arguments[3] : arguments[2];
	this.DefC = arguments.length == 6  ? arguments[4] : arguments[3];
	this.DefA = arguments.length == 6  ? arguments[5] : arguments[4];
	this.SelP.PCA = this;
	this.SelC.PCA = this;
