...
cities['浙江省'] = new Array('杭州', '湖州', '嘉兴', '舟山', '宁波', '绍兴', '金华', '台州', '温州',
		'丽水');
...
function set_city(province, city,exist){
	var array=[];
	if(exist!=null){
		array = exist.split(";");
		if(array[0] !=null || array[0]!=''){
			for (var i = 0; i < province.length; i++) {
				if(province[i].value==array[0]){
		...
		if(array[1]!=null && array[1]!=''){
			...
			city.options[0].text = array[1];
			city.options[0].value = array[1];
