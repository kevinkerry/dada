...
<body>
		...
		<form class="form-horizontal" action="${ctx}/activity/updateSnatchActivity" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-7 form-inline">
					 <input class="form-control" id="hdmc" name="title" value="${activity.title}" style="width: 30%;" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="csjjc" name="snatchActivity.initialBonus"  value="${activity.snatchActivity.initialBonus}" placeholder="元体验金" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" >最少参与人：</label>
				<div class="col-sm-1 form-inline">
				     <input class="form-control"  type="number" id="zscyr" name="snatchActivity.minNum" value="${activity.snatchActivity.minNum}" placeholder="人/次" />
				</div>
				<label class="col-sm-3 control-label" >达到之后，每多一人次，奖金池增加：</label>
				<div class="col-sm-2 form-inline">
				    <input class="form-control"  type="number" id="jjczj" name="snatchActivity.contributeBonus" value="${activity.snatchActivity.contributeBonus}" placeholder="体验金" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-3 form-inline">
				    ...
				    <input class="form-control" style="width: 110px;" type="text" id="zfjy" name="snatchFeeList[0].money" value="${activity.snatchFeeList[0].money}" />元
				    <input class="form-control" style="width: 110px;" type="number" id="zfjc" name="snatchFeeList[0].count" value="${activity.snatchFeeList[0].count}" />次
					...
					<c:if test="${status.index>0}">
						<div class="form-group" id="node${status.index}">
							...
							<div class="col-sm-3 form-inline">
								...
								<input class="form-control" style="width: 110px;" type="text"   name="snatchFeeList[${(status.index)}].money" value="${a.money}" />元
							    <input class="form-control" style="width: 110px;" type="number" name="snatchFeeList[${(status.index)}].count" value="${a.count}" />次
						    </div>
					    </div>
				    </c:if>
				</c:forEach>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
				    <input class="form-control" style="width: 170px;" type="number" id="hjr" name="snatchActivity.winNum" value="${activity.snatchActivity.winNum}" placeholder="数" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" >跑量折算：</label>
				<div class="col-sm-1 form-inline">
				     <input class="form-control" style="width: 170px;" type="number" id="plzs" name="snatchActivity.stepToDistance" value="${activity.snatchActivity.stepToDistance}" placeholder="步" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" >每日最多步数：</label>
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="mrzdbs" name="snatchActivity.maxStep" value="${activity.snatchActivity.maxStep}" placeholder="步" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" >每日最多跑量：</label>
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="mrzdpl" name="snatchActivity.maxDistance" value="${activity.snatchActivity.maxDistance}" placeholder="km" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-7 form-inline">
					 <input class="form-control" id="hdts" name="snatchActivity.message"  value="${activity.snatchActivity.message}" style="width: 100%;" />
				</div>
				<div class="col-sm-2 form-inline">
					<input class="form-control" id="tssj" type="datetime-local" value="${activity.snatchActivity.cronExpression}"/>
			...
			<div class="form-group">
				<div class="col-sm-10 form-inline">
					 <textarea class="form-control" id="gz" name="snatchActivity.rule" style="width: 100%;height: 50%;" >${activity.snatchActivity.rule}</textarea>
				</div>
			</div>
    ...
    <script type="text/javascript">
		...
		$(function(){
			...
			num = parseInt(num)-1;
			// console.log('${activity.snatchFeeList.size()}');
