	...
	<%@include file="/common/page.jsp" %>
		 ...
		 <script type="text/javascript">
			...
			function queryList() {
				...
				var url="${ctx}/adminuser/list?currentPage="+currentPage+"&pageSize="+pageSize;
			    if(!isEmpty(username)){
			...
			function updateUser() {
				...
				location.href="${ctx}/adminuser/"+selectedUserId+"/update";
			}
			 ...
			 */
			 function deleteUser() {
				...
				swal({
					...
					function(isConfirm) {
						if (isConfirm) {
							location.href = "${ctx}/adminuser/" + selectedUserId + "/delete";
						}
					});
