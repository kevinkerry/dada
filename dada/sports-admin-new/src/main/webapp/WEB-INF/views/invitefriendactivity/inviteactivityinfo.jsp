...
<body>
	<div class="container-fluid">
		<ul class="nav nav-tabs" id="myTab">
		  ...
		  <li><a href="#userInfo"  onclick="inviteactivityUserPage(${activity.id})" >用户详情</a></li>
		</ul>
		...
		<form class="form-horizontal" action="${ctx}/activity/updateInviteFriend" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="yqjl" name="couponsList[0].bonus" value="${activity.couponsList[0].bonus}" readonly="readonly" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" >注册奖励：</label>
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="zcjl" name="couponsList[1].bonus" value="${activity.couponsList[1].bonus}" readonly="readonly"/> 
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2 form-inline">
					 <select class="form-control" id="yxSelect" name="couponsList[0].expiryDay" disabled="disabled">
					</select>
			...
			<div class="form-group">
				...
				<div class="col-sm-7 form-inline">
					 <input class="form-control" id="hdts" name="inviteFriendActivity.message" style="width: 100%;" value="${activity.inviteFriendActivity.message}" readonly="readonly"/>
				</div>
				<div class="col-sm-2 form-inline">
					<input class="form-control" id="tssj" type="datetime-local" value="${activity.inviteFriendActivity.cronExpression}" readonly="readonly"/>
			...
			<div class="form-group">
				<div class="col-sm-10 form-inline">
					 <textarea class="form-control" id="gz" name="inviteFriendActivity.rule" style="width: 100%;height: 50%;" readonly="readonly">${activity.inviteFriendActivity.rule}</textarea>
				</div>
			</div>
		</form>
    ...
    <script type="text/javascript">
		...
		function inviteactivityUserPage(activityId){
			location.href ="${ctx}/invitefriendactivity/getUserInvite?&activityId="+activityId;
		}
