...
<body>
	<div class="container-fluid">
		<form class="form-horizontal" action="${ctx}/activity/addInviteFriend" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="yqjl" name="couponsList[0].bonus" value="1000" />
				    <input type="hidden"  name="couponsList[0].type" value="8" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" >注册奖励：</label>
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="zcjl" name="couponsList[1].bonus" value="1000" />
				    <input type="hidden"  name="couponsList[1].type" value="9" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-7 form-inline">
					 <input class="form-control" id="hdts" name="inviteFriendActivity.message"   style="width: 100%;" />
				</div>
				<div class="col-sm-2 form-inline">
			...
			<div class="form-group">
				<div class="col-sm-10 form-inline">
					 <textarea class="form-control" id="gz" name="inviteFriendActivity.rule" style="width: 100%;height: 50%;" ></textarea>
				</div>
			</div>
    ...
    <script src="${ctx }/resources/js/invitefriendactivity/addinvitefriendactivity.js"></script>
