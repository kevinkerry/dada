...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!--/.fluid-container-->
        <link rel="stylesheet" href="${ctx }/resources/vendors/morris/morris.css">


        <script src="${ctx }/resources/vendors/jquery-1.9.1.min.js"></script>
        <script src="${ctx }/resources/vendors/jquery.knob.js"></script>
        <script src="${ctx }/resources/vendors/raphael-min.js"></script>
        <script src="${ctx }/resources/vendors/morris/morris.min.js"></script>

        <script src="${ctx }/resources/bootstrap/js/bootstrap.min.js"></script>
        <script src="${ctx }/resources/vendors/flot/jquery.flot.js"></script>
        <script src="${ctx }/resources/vendors/flot/jquery.flot.categories.js"></script>
        <script src="${ctx }/resources/vendors/flot/jquery.flot.pie.js"></script>
        <script src="${ctx }/resources/vendors/flot/jquery.flot.time.js"></script>
        <script src="${ctx }/resources/vendors/flot/jquery.flot.stack.js"></script>
        <script src="${ctx }/resources/vendors/flot/jquery.flot.resize.js"></script>
