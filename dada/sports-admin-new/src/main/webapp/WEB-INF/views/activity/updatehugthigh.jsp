		...
		<form class="form-horizontal" action="${ctx}/activity/updateHugThigh" method="post">
			...
			<div class="form-group">
				...
				<div  class="col-sm-3  form-inline">
					...
					<input class="form-control" id="bTime" type="time" value="<fmt:formatDate pattern="HH:mm" value="${myDate}" />" style="width: 115px;" /> 至
					<c:set target="${myDate}" property="time" value="${activity.endTime}" /> 
					<input class="form-control" id="eTime" type="time" value="<fmt:formatDate pattern="HH:mm" value="${myDate}" />" style="width: 115px;" />
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="dtme" name="hugThighActivity.thighLimit" value="${activity.hugThighActivity.thighLimit}" />
				</div>
				<label class="col-sm-1 control-label" >被抱次数：</label>
				<div class="col-sm-2">
				    <input class="form-control" type="number" id="dtcs" name="hugThighActivity.hugThighLimit" value="${activity.hugThighActivity.hugThighLimit}" />
				</div>
			</div>
			<div class="form-group">
					...
					<tr>
						...
						<tbody>
							<tr>
							    ...
							    <td><input class="form-control" type="number" id="tyj1" name="couponsList[0].bonus" value="${activity.couponsList[0].bonus}" /></td>
							    <td><input class="form-control" type="text" id="yj1" name="couponsList[0].commission" value="${activity.couponsList[0].commission}" onchange="zfyj(this,'label1','pt1')" /></td>
							...
							<tr>
							    ...
							    <td><input class="form-control" type="number" id="tyj2" name="couponsList[1].bonus" value="${activity.couponsList[1].bonus}" /></td>
							    <td><input class="form-control" type="text" id="yj2" name="couponsList[1].commission" value="${activity.couponsList[1].commission}" onchange="zfyj(this,'label2','pt2')" /></td>
							...
							<tr>
							    ...
							    <td><input class="form-control" type="number" id="tyj3" name="couponsList[2].bonus" value="${activity.couponsList[2].bonus}"/></td>
							    <td><input class="form-control" type="text" id="yj3" name="couponsList[2].commission" value="${activity.couponsList[2].commission}" onchange="zfyj(this,'label3','pt3')" /></td>
							...
							<tr>
							    ...
							    <td><input class="form-control" type="number" id="tyj4" name="couponsList[3].bonus" value="${activity.couponsList[3].bonus}"/></td>
							    <td><input class="form-control" type="text" id="yj4" name="couponsList[3].commission" value="${activity.couponsList[3].commission}" onchange="zfyj(this,'label4','pt4')" /></td>
							...
							<tr>
							    ...
							    <td><input class="form-control" type="number" id="tyj5" name="couponsList[4].bonus" value="${activity.couponsList[4].bonus}"/></td>
							    <td><input class="form-control" type="text" id="yj5" name="couponsList[4].commission" value="${activity.couponsList[4].commission}" onchange="zfyj(this,'label5','pt5')" /></td>
							...
							<tr>
							    ...
							    <td><input class="form-control" type="number" id="tyj6" name="couponsList[5].bonus" value="${activity.couponsList[5].bonus}"/></td>
							    <td><input class="form-control" type="text" id="yj6" name="couponsList[5].commission" value="${activity.couponsList[5].commission}" onchange="zfyj(this,'label6','pt6')" /></td>
							...
							<tr>
							    ...
							    <td><input class="form-control" type="number" id="tyj7" name="couponsList[6].bonus" value="${activity.couponsList[6].bonus}"/></td>
							    <td><input class="form-control" type="text" id="yj7" name="couponsList[6].commission" value="${activity.couponsList[6].commission}" onchange="zfyj(this,'label7','pt7')" /></td>
			...
			<div class="form-group">
				...
				<div class="col-sm-2 form-inline">
					<input class="form-control" type="text" id="pjbf" name="hugThighActivity.stride" value="${activity.hugThighActivity.stride}" style="width: 100px;" />米
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" >平均速度不超过</label>
				<div class="col-sm-2 form-inline">
					<input class="form-control" type="number" id="pjsd" name="hugThighActivity.avspeed" value="${activity.hugThighActivity.avspeed}" style="width: 100px;" />km/h
				</div>
				<label class="col-sm-1 control-label" >最快速度不超过</label>
				<div class="col-sm-2 form-inline">
					<input class="form-control" type="number" id="zksd" name="hugThighActivity.maxspeed" value="${activity.hugThighActivity.maxspeed}" style="width: 100px;" />km/h
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" >活动开始推送：</label>
				<div class="col-sm-7 form-inline">
					 <input class="form-control" id="hdts" name="hugThighActivity.message" value="${activity.hugThighActivity.message}" style="width: 100%;" />
				</div>
				<div class="col-sm-2 form-inline">
					<input class="form-control" id="tssj" type="datetime-local" name="hugThighActivity.cronExpression"  value="${activity.hugThighActivity.cronExpression}"/>
			...
			<div class="form-group">
				<div class="col-sm-10 form-inline">
					 <textarea class="form-control" id="gz" name="hugThighActivity.rule" style="width: 100%;height: 50%;" >${activity.hugThighActivity.rule}</textarea>
				</div>
			</div>
			<div class="form-group" style="margin-left: 500px;">
			    <button id="sumit" class="btn btn-primary" style="width: 150px;">保存活动</button>
		...
		function initData(){
			...
			for (var i = 1; i <=30; i++) {
				if(i==htflts){
					...
					//设置福利天数
					for (var k = 0; k < 7; k++) {
						$("#flts").append("<input type='hidden' name='couponsList["+k+"].expiryDay' value='"+i+"' />");
					}
				}else{
