...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!--/.fluid-container-->
        <link href="${ctx }/resources/vendors/datepicker.css" rel="stylesheet" media="screen"/>
        <link href="${ctx }/resources/vendors/uniform.default.css" rel="stylesheet" media="screen"/>
        <link href="${ctx }/resources/vendors/chosen.min.css" rel="stylesheet" media="screen"/>

        <link href="${ctx }/resources/vendors/wysiwyg/bootstrap-wysihtml5.css" rel="stylesheet" media="screen"/>

        <script src="${ctx }/resources/vendors/jquery-1.9.1.js"></script>
        <script src="${ctx }/resources/bootstrap/js/bootstrap.min.js"></script>
        <script src="${ctx }/resources/vendors/jquery.uniform.min.js"></script>
        <script src="${ctx }/resources/vendors/chosen.jquery.min.js"></script>
        <script src="${ctx }/resources/vendors/bootstrap-datepicker.js"></script>

        <script src="${ctx }/resources/vendors/wysiwyg/wysihtml5-0.3.0.js"></script>
        <script src="${ctx }/resources/vendors/wysiwyg/bootstrap-wysihtml5.js"></script>

        <script src="${ctx }/resources/vendors/wizard/jquery.bootstrap.wizard.min.js"></script>

	<script type="text/javascript" src="vendors/jquery-validation/dist/jquery.validate.min.js"></script>
	<script src="${ctx }/resources/assets/form-validation.js"></script>
