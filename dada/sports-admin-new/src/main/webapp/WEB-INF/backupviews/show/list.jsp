    ...
    <body>
        <div class="container-fluid">
            <form id="search_form" class="form-group form-inline" style="margin-bottom: 10px;" action="${ctx}/show/list" method="post">
				...
				<input class="form-control col-md-offset-1" id="userName" type="search" name="showUser.userName" value="${page.params.showUser.userName}" placeholder="请输入哒人姓名" style="width: 150px;"/>
