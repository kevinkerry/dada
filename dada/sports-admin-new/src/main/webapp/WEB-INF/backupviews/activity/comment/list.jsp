    ...
    <body>
        <div class="container-fluid">
			<div class="form-group form-inline">	
				<legend>活动名称：${activityTitle}</legend>
...
<script>
	...
	function changeStatus(status, dom, event) {
		...
		location.href = "${ctx}/comment/changeStatus?commentId="+commentId+"&status="+status;
	}
	
	function goPage(num, pageSize) {
		location.href = "${ctx}/comment/list?currentPage="+num+"&pageSize="+pageSize+"&activityId=${activityId}";
	}
</script>
