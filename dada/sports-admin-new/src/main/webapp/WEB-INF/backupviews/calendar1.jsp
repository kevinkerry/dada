...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="${ctx }/resources/vendors/fullcalendar/fullcalendar.css" rel="stylesheet" media="screen">
    ...
    <body>
        ...
        <script src="${ctx }/resources/vendors/jquery-ui-1.10.3.js"></script>
        <script src="${ctx }/resources/bootstrap/js/bootstrap.min.js"></script>
        <script src="${ctx }/resources/vendors/fullcalendar/fullcalendar.js"></script>
        <script src="${ctx }/resources/vendors/fullcalendar/gcal.js"></script>
