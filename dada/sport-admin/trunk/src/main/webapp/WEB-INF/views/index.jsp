...
<html>
	...
	<body style="overflow:hidden;">
			...
			<nav class="navbar navbar-default navbar-fixed-top">
			  <div class="frame-header-container">
			      ...
			      <ul class="nav navbar-nav navbar-left first-nav">
			     		 <li role="presentation" data-id="index">
	                         <a href="${ctx}/user/dashboard.html" target="mainFrame"><font>首页</font></a>
	                      </li>
			      	...
			      	<%--  <li role="presentation">
			      	 ...
			      	 <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a tabindex="-1" href="${ctx}/user/logout">退出</a>
                            </li>
                        </ul>
                     </li>
			      </ul>
		...
		<div id="frame-center">
			...
			<div id="main-content">
				<iframe id="mainFrame" name="mainFrame" src="${ctx}/user/dashboard.html" style="overflow:hidden;" scrolling="no" frameborder="no"></iframe>
			</div>
		</div>
						...
						<div id="change_head_portrait" class="tab-pane">
							<div id="user_profile_current_head">
								<div id="user_profile_current_head_title">
									...
									<div >
										<img src="${image }${user.headPortrait}" width="100px;" height="100px;" class="user_profile_current_head_img"/>
									</div>
