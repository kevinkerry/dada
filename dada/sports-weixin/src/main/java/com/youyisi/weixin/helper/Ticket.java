package com.youyisi.weixin.helper;
...
import com.youyisi.weixin.cache.redis.RedisClient;
import com.youyisi.weixin.domain.AccessToken;
...
public class Ticket {
	...
	private static String getTiket(String ticket, AccessToken accessToken) {
		String tiket_url = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token="
		...
		if (null != jsonObject2) {
			...
			try {
				Map<String, String> map = JsonHelper.fromJsonString(
						jsonObject2, Map.class);
				...
				accessToken = null;
				// 获取token失败
				// log.error("获取token失败 tiket:{} errmsg:{}",
	...
	public static String getOpenId(String code) {
		String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxf8bd7ea02a023bb7&secret=8ec09ab1d9e46427a6a88fd4a0884082&code="
